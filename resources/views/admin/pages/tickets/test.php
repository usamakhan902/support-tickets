...
<!-- Mirrored from designreset.com/cork/html/vertical-dark-menu/app-blog-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Jun 2023 13:43:44 GMT -->
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="apps" data-bs-parent="#accordionExample">
                            ...
                            <li>
                                <a href="#blog" data-bs-toggle="collapse" aria-expanded="true"
                                ...
                                <ul class="collapse list-unstyled sub-submenu show" id="blog" data-bs-parent="#apps">
                                    <li>
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-4">
                            ...
                            <div class="single-post-content">
                                ...
                                <div class="post-content">
                                    ...
                                    <p class="mb-5">Aenean non tempor justo. Donec faucibus sapien a urna interdum
                                        porta. Quisque fermentum nisi felis, quis aliquam quam volutpat porta. Nullam
                                        aliquet scelerisque massa, quis tincidunt velit. Vivamus semper placerat ornare.
                                        Maecenas eget accumsan eros. Donec non felis vitae tortor elementum euismod sit
                                        amet vitae risus. Nam nunc turpis, porttitor ut tempor eu, efficitur nec risus.
                                    </p>

                                    <h4>Cinyras ea tulit in inducit qui mater</h4>

                                    <p class="mb-5">Lorem markdownum facit? Hinc tutus serisque, mihi iaculum curam,
                                        vicibus aliquando se posses gentis quidem. Meta tenebat diversa dixerat
                                        celeberrimus molle require; prendique urnam Pyreneus? Haut mei sive digna
                                        noctisque percussit dicta, in pars certaminis iuvenalis. Praemonuisse esse inter
                                        in huic, Cinyras pallentem vi sistere cubat ne causa.</p>

                                    <h4>Utque tu canibus</h4>

                                    <p class="mb-5">Possent quippe. Conata fera ab Hersilie iam auditur haesit. Culpa
                                        ignis retia Aonides ictus crescendo micantes, petere, ambustaque vicem in
                                        digitos iubet cornigeris.</p>
                                    ...
                                    <p>Manet pro aere superest adiacet sua purpura Tereus in multis conantem culpa,
                                        inque fingit et referebat? Materiaque mentes et, quo omnia captiva ore mandat
                                        cepit triformis filia. Prius sorte nomina in repellite sentit facunde te aures,
                                        vires.</p>
...
&lt;/button&gt; </pre>
                                    ...
                                    <p class="mb-5">Fama creatis cum; ait atque et ictaque stabat, si texit continuere
                                        exsatiata vestes, humana arces. Moriens carissime pudet dextra et aures micantes
                                        est, in. Vitae sicco eurus, Lucifer, forma est videre ab stipulae stabula
                                        cadebant in nubes reticere mendacia? Adice Ladon petis. Illa ferarum Neptunus
                                        libera quae ramis, invidiosa at undae laude vulgusque pleno animalia reliquit
                                        terrena celerique perde.</p>

                                    <h4>Nocte populusque</h4>

                                    <p>Lorem markdownum, ponere patent ista, Cadme, adesse humum non forem putares;
                                        adiuro ore viresque est. Inde labores si sustinet regia, levi oris pascere!
                                        Rhodon ad lingua perdidit inpia alis! Maiorque de duro!</p>

                                    <p class="mb-5">Sit et angues referente proxima Emathiique nemo: herbae servant eo
                                        corpus cornua tenuata recuso; natis parentem. Nisi nec aquarum, nymphae.</p>

                                    <img src="../src/assets/img/lightbox-3.jpg" alt="image-1"
                                        class="full-width img-fluid mt-4 mb-5">

                                    <h4>Novato extrema monimenta clivo ille</h4>

                                    <p class="mb-5">Recessit mox patrem ille mea, tumulatus teneri hominis, favilla enim
                                        recentes deam cur nocte pro eburnea. Favilla iam suis horruerant Chiae
                                        quotiensque ingemuit locumque ducere postquam alebat. Iovi caeli esse superet
                                        contraria conscia transierant verae; ut vetuere, suo gerat lumina rugis
                                        velletque. Facta innecte de relicta Chrysenque morte, laedor dea aequaret dedit!
                                        Sustinui attulit proles potentior.</p>


                                    <h4>Aliquod corpora sororibus crimine ornata</h4>

                                    <p class="mb-5">Est convicia et nubibus negate. In nisi inbellibus sui, cruribus
                                        vult hostes solum invitat. Vino faciam stratis; non modo in eurus igitur, ambit,
                                        mentitus periclo? Ullo dextra, extemplo commenta ultima, quid ire vos toto quia,
                                        in habili Gradivus ferarum certaminis attulerat.</p>


                                    <h4>Nemus dolet monstravit</h4>

                                    <p class="mb-5">Est et hic volucres, rursus; simul, cauda tamen cacumine pars
                                        intendensque . Maius dignior caret coniuge, demugitaeque duce, exponimur anus
                                        inritata. Quoque sum casusve corpora, dat caecis doloris scelus domesticus
                                        laboris heu quod reliquit. Albenti infra sed Pergama vivere fusus de fecerat
                                        sublime prosunt illic. Consensu pavet insistit terras!</p>
                                    ...
                                    <div class="post-dynamic-meta mt-5 mb-5">
                                        ...
                                        <div class="avatar--group mb-2">
                                            <div class="avatar avatar-sm m-0">
                                                <img alt="avatar" src="../src/assets/img/profile-16.jpg"
                                                    class="rounded-circle">
                                            </div>
                                            <div class="avatar avatar-sm">
                                                <img alt="avatar" src="../src/assets/img/delete-user-4.jpg"
                                                    class="rounded-circle">
                                            </div>
                                            <div class="avatar avatar-sm">
                                    ...
                                    <div class="post-comments">
                                        ...
                                        <div class="media mb-5 pb-5 primary-comment">
                                            ...
                                            <div class="avatar me-4">
                                                <img alt="avatar" src="../src/assets/img/profile-2.jpg"
                                                    class="rounded-circle" />
                                            </div>
                                            <div class="media-body">
                                                <h5 class="media-heading mb-1">Daisy Andrason</h5>
                                                <div class="meta-info mb-0">14 April</div>
                                                <p class="media-text mt-2 mb-0">Fusce condimentum cursus mauris et
                                                    ornare. Mauris fermentum mi id sollicitudin viverra. Aenean
                                                    dignissim sed ante eget dapibus. Sed dapibus nulla elementum, rutrum
                                                    neque eu, gravida neque.</p>
                                                ...
                                                <div class="media mb-4 mt-4">
                                                    ...
                                                    <div class="avatar me-4">
                                                        <img alt="avatar" src="../src/assets/img/profile-3.jpg"
                                                            class="rounded-circle" />
                                                    </div>
                                                    <div class="media-body">
                                                        <h5 class="media-heading mb-1">Xavier</h5>
                                                        <div class="meta-info mb-0">15 April</div>
                                                        <p class="media-text mt-2 mb-0">Fusce condimentum cursus mauris
                                                            et ornare. Mauris fermentum mi id sollicitudin viverra.
                                                            Aenean dignissim sed ante eget dapibus. Sed dapibus nulla
                                                ...
                                                <div class="media mt-4">
                                                    ...
                                                    <div class="avatar me-4">
                                                        <img alt="avatar" src="../src/assets/img/profile-25.jpg"
                                                            class="rounded-circle" />
                                                    </div>
                                                    <div class="media-body">
                                        ...
                                        <div class="media mb-5 pb-5 primary-comment">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="media mt-4">
                                                    ...
                                                    <div class="avatar me-4">
                                                        <img alt="avatar" src="../src/assets/img/profile-21.jpg"
                                                            class="rounded-circle" />
                                                    </div>
                                                    <div class="media-body">
                                        ...
                                        <div class="media mb-5 pb-5 primary-comment">
                                            ...
                                            <div class="avatar me-4">
                                                <img alt="avatar" src="../src/assets/img/profile-9.jpg"
                                                    class="rounded-circle" />
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <div class="post-pagination">
                                            ...
                                            <div class="pagination-no_spacing">
                                                ...
                                                <ul class="pagination">
                                                    <li><a href="javascript:void(0);" class="prev"><svg
                                                    ...
                                                    <li><a href="javascript:void(0);" class="next"><svg
                                                                xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
...
<!-- Mirrored from designreset.com/cork/html/vertical-dark-menu/app-blog-post.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 Jun 2023 13:43:46 GMT -->
